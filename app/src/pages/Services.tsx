  ...
  const services = [
    {
      ...
      details: 'Our streamlined admission process makes it easy for new students to join Galaxy Library. Our experienced admission team provides expert guidance through every step, from application to enrollment. We ensure transparent communication and personalized attention for each student.',
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#64748b] max-w-3xl mx-auto leading-relaxed">
            At Galaxy Library, we provide comprehensive educational services covering every aspect of student management and academic excellence. From admissions to records management, we handle it all with transparency and professionalism.
          </p>
        </div>
        ...
        <article className="mt-16 prose prose-sm max-w-none">
          ...
          <p className="text-[#64748b] leading-relaxed mb-4">
            Galaxy Library in {libraryInfo?.location || 'Tehta'} provides comprehensive educational services designed to support students at every stage of their academic journey. From new admissions to complete fee management and student record maintenance, we handle all aspects with professionalism and transparency.
          </p>

          <h3 className="text-2xl font-bold mt-8 mb-4 text-[#1e293b]">Admission Services</h3>
          <p className="text-[#64748b] leading-relaxed mb-4">
            Our admission services are designed to make the process as smooth as possible. Whether you're seeking admission to Galaxy Library or looking for guidance on educational options, our team is here to help. We provide expert counseling, handle all paperwork, and ensure your admission is processed quickly and transparently.
          </p>
        ...
        <div className="text-center bg-gradient-to-r from-[#3b82f6] to-[#2563eb] rounded-xl p-8 sm:p-12 text-white mt-16">
          ...
          <p className="text-lg mb-6 max-w-2xl mx-auto">
            Start your journey with Galaxy Library today and experience quality education with comprehensive support
          </p>
