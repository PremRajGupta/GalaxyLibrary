...
export default function SEOHomeSection({ libraryInfo }: SEOHomeSectionProps) {
  const schoolName = libraryInfo?.name || 'Galaxy Library';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] to-[#60a5fa]">Galaxy Library</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-8">
            ...
            <p className="text-[#cbd5e1] mb-4">
              Galaxy Library is proud to serve the {location} community and surrounding areas with quality 
        ...
        <article className="mt-16 prose prose-invert max-w-none text-[#cbd5e1]">
          <h2 className="text-3xl font-bold mb-6 text-white">About Galaxy Library - Educational Excellence in {location}</h2>
          
          <p className="leading-relaxed mb-4">
            <strong>Galaxy Library</strong> stands as the premier educational institute in {location}, {city}, dedicated to 
          ...
          <p className="leading-relaxed mb-4">
            ...
            From primary to advanced education, Galaxy Library offers structured pathways for academic success. Our comprehensive 
            curriculum focuses on both theoretical knowledge and practical application.
          </p>

          <h3 className="text-2xl font-bold mt-8 mb-4 text-white">Admissions at Galaxy Library</h3>
          <p className="leading-relaxed mb-4">
            Seeking admission to a quality educational institute? Galaxy Library provides streamlined admission processes with 
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4 text-white">Why Choose Galaxy Library in {location}?</h3>
          ...
          <p className="leading-relaxed mt-6">
            Whether you're searching for "galaxy library", "galaxy library in tehta", "galaxy education" or looking for 
            the best educational institute in {location}, Galaxy Library is your destination for quality education and 
